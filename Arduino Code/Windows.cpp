...
void DrawMenuScreen() {
    ...
    tft.fillRoundRect(45, 40, 230, 50, 10, DARKRED); 
    tft.drawRoundRect(45, 40, 230, 50, 10, WHITE);  
    text("Sensors", 100, 55,3, BLACK, WHITE );
    ///////////////// Simulation
    tft.fillRoundRect(45+5, 100+5, 230, 50, 10, WHITE);
    tft.fillRoundRect(45, 100, 230, 50, 10, BLUE);  
    tft.drawRoundRect(45, 100, 230, 50, 10, WHITE);  
    text("Simulation", 75, 115,3, BLACK, WHITE );
    ///////////////// CONFIG
    tft.fillRoundRect(45+5, 160+5, 230, 50, 10, WHITE);
    tft.fillRoundRect(45, 160, 230, 50, 10, DARKGRAY);  
    tft.drawRoundRect(45, 160, 230, 50, 10, WHITE);  
...
void DrawSettingsScreen() {
  ...
  tft.fillRoundRect(1, 1, 319, 75,5, DARKGRAY);  
  tft.drawRoundRect(1, 1, 319, 75,5, WHITE); 
  ...
  /// Midterste ting:
  tft.fillRoundRect(1, 76, 319, 75,5, DARKGRAY); 
  tft.drawRoundRect(1, 76, 319, 75,5, WHITE); 
  /// Nederste ting:
  tft.fillRoundRect(1, 151, 319, 80,5, DARKGRAY);  
  tft.drawRoundRect(1, 151, 319, 80,5, WHITE);  
